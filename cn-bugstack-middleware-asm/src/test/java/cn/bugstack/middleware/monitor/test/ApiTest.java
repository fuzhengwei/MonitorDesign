...
public class ApiTest extends ClassLoader{
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputClazz(bytes);
        // 加载AsmHelloWorld
        Class<?> clazz = new ApiTest().defineClass("cn.bugstack.demo.asm.AsmHelloWorld", bytes, 0, bytes.length);
        // 反射获取 main 方法
    ...
    private static void outputClazz(byte[] bytes) {
        ...
        try {
            String pathName = ApiTest.class.getResource("/").getPath() + "AsmHelloWorld.class";
